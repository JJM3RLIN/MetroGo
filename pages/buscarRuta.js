      ...
      <main className="grid grid-cols-2 place-content-center ">
        ...
        <section className="mt-6 text-center">
          ...
          <div className="flex flex-col items-center justify-center mb-8">
            <label htmlFor="inicio" className="text-4xl mb-6">¿En qué estación te encuentras?</label>
            <input 
            type="text"
            id="inicio" 
            onChange={(e)=>setRuta({...ruta, inicio: e.target.value})}
            className="bg-gray-200 px-2 py-4 w-3/4 outline-none border rounded-xl text-3xl focus:border-amber-500"
            placeholder="Ejemplo: Politécnico"/>
          </div>

          <div className="flex flex-col items-center justify-center mb-8">
            <label htmlFor="" className="text-4xl mb-6">¿A qué estación te diriges?</label>
            <input 
            type="text" 
